...
def idf(term, documents)
  ...
  return "Dividing by zero" if number_of_documents_with_term == 0

  Math.log(number_of_documents / number_of_documents_with_term) unless number_of_documents_with_term == 0
end
